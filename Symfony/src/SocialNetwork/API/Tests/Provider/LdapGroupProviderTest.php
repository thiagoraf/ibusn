...
use Symfony\Bundle\FrameworkBundle\Test\WebTestCase,
    ...
    SocialNetwork\API\Provider\LdapGroupProvider,
    SocialNetwork\API\Provider\Criteria;

class LdapGroupProviderTest extends WebTestCase
{
    private $rProvider;
    private $group;
    private $criteria;
    ...
    protected function setUp()
    {
        ...
        $this->rProvider = new LdapGroupProvider( $client->getContainer(), $map['parameters']['provider_group_map'] );
